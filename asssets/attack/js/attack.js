$(function() {
  ...
  function loaded(error, countries) {
    ...
    svg.append("circle")
      .attr("cx", circle_orign[0])
      .attr("cy", circle_orign[1])
      .attr("r", 30)
      .attr("fill-opacity", 0.1)
      .attr("fill", "rgb(91, 43, 130)")
      .attr("stroke-width", 1)
      .attr("stroke", "rgb(91, 43, 130)")
  ...
  queue().defer(d3.json, "/flight/json/countries2.topo.json")
         .defer(d3.json, "/flight/json/airports2.topo.json")
         .await(loaded);
})